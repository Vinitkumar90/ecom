  ...
  return productData ? (
    <div className="border-t border-gray-200 pt-10 transition-opacity ease-in duration-500 opacity-100">
                ...
                return (
                  <button
                    ...
                    className={`border py-2 px-4 bg-gray-100 ${
                      size === item ? "border-black" : "border-none"
                    }`}
      ...
      {/*---------- description and review section ------------  */}
        <div className="mt-20">
              <div className="flex ">
                <b className="border border-gray-300 border-b-0 text-gray-800 px-5 py-3 text-sm">Description</b>
                <p className="border border-gray-300 border-b-0 text-gray-800 px-5 py-3 text-sm">Reviews</p>
              </div>
