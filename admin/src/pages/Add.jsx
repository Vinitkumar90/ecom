      ...
      <div>
        <div>
          ...
          <div className="flex gap-3">
            ...
            <div onClick={(e) => setSizes(prev => prev.includes("M") ? prev.filter((size) => size!== 'M') : [...prev,"M"])}>
               <p className={`${sizes.includes("M") ? "bg-pink-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>M</p>
            </div>
            <div onClick={(e) => setSizes(prev => prev.includes("L") ? prev.filter((size) => size!== 'L') : [...prev,"L"])}>
               <p className={`${sizes.includes("L") ? "bg-pink-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>L</p>
            </div>
            <div onClick={(e) => setSizes(prev => prev.includes("XL") ? prev.filter((size) => size!== 'XL') : [...prev,"XL"])}>
               <p className={`${sizes.includes("XL") ? "bg-pink-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>XL</p>
            </div>
            <div onClick={(e) => setSizes(prev => prev.includes("XXL") ? prev.filter((size) => size!== 'XXL') : [...prev,"XXL"])}>
